...
use ride\web\table\filebrowser\decorator\ClipboardFileDecorator;
//use ride\web\table\filebrowser\decorator\FileOptionDecorator;
use ride\web\filebrowser\decorator\FileOptionDecorator;
//use ride\library\html\table\decorator;
...
class ClipboardTable extends FormTable {
     ...
     * @param ride\library\system\file\File $root Path of the root for the filebrowser
