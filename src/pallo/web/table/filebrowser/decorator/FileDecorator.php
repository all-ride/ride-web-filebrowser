...
use pallo\web\model\filebrowser\filter\DirectoryFilter;
...
class FileDecorator extends AbstractFileDecorator {
     ...
     * @param pallo\filebrowser\model\FileBrowser $fileBrowser The file browser we're working for
     * @return null
     */
     ...
     * @param pallo\library\filesystem\File $directory The directory to get the
     * HTML for
     ...
     * @param pallo\library\system\file\File $file The file to get the HTML for
