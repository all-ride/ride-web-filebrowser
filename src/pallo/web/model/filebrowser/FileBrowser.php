...
namespace pallo\web\model\filebrowser;
...
class FileBrowser {
     ...
     * @param pallo\library\system\\fileFile $root The root of your browser
     * @return null
     */
     ...
     * @param pallo\library\system\file\File $path Path of the directory to read
    ...
    public function applyFilters(array $files, array $filters) {
        ...
        foreach ($files as $key => $file) {
            if (!($file instanceof File)) {
                throw new Exception('Element at key ' . $key . ' is not an instance of pallo\\library\\system\file\File');
            }
     ...
     * @return null
     * @throws pallo\palloException when no filters provided
     * @throws pallo\palloException when a invalid filter is in the provided array
     */
    private function checkFilters(array $filters) {
        ...
        foreach ($filters as $filter) {
            if (!($filter instanceof Filter)) {
                throw new Exception('Invalid filter provided, use instance of pallo\\app\\model\\filebrowser\\filter\\Filter');
            }
        }
    }
     ...
     * @param pallo\library\system\file\File $path Path to check
     ...
     * @param pallo\library\system\file\File $path File to get the size of
     ...
     * @param pallo\library\system\file\File $root The root path
     * @param pallo\library\system\file\File $file The file to check
     ...
     * @param pallo\library\system\file\File $file File to get the path for
     * @param boolean $addRoot Set to false if the root of the browser is already added to the provided file
     * @return pallo\library\system\file\File The relative path of the provided file
     */
